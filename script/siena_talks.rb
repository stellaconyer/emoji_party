...
realm_talk = Talk.create!(
  ...
  slides_link: "https://speakerdeck.com/sienaigg/gotta-persist-em-all-realm-as-replacement-for-sqlite"
  )
...
i18n_talk = Talk.create!(
  ...
  slides_link: "https://speakerdeck.com/sienaigg/fearless-internationalization-and-localization-across-the-nations"
  )
